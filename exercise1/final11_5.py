...
# no trigram ,then use [1:] , not[:2].  no bigram then use [3], not[0]
...
if __name__ == '__main__':
    ...
    # print('perplexity_back122 of remaining rows is ' + str(pp_back2))
    pp_back = perplex5(data_without_lemma_3000, data_without_lemma_16000)
    print('perplexity_back1 of remaining rows is ' + str(pp_back))
    pp_back = perplex6(data_without_lemma_3000, data_without_lemma_16000)
    print('perplexity_back1 of remaining rows is ' + str(pp_back))
    pp_back = perplex3(data_3, data_16)
    print('perplexity_back1 of remaining rows is ' + str(pp_back))

    pp_back = perplex4(data_3, data_16)
    print('perplexity_back1 of remaining rows is ' + str(pp_back))

    pp_back = perplex5(data_3, data_16)
    print('perplexity_back1 of remaining rows is ' + str(pp_back))
    pp_back = perplex6(data_3, data_16)
    print('perplexity_back1 of remaining rows is ' + str(pp_back))
    end = time.time()
    time3 = time.time()
