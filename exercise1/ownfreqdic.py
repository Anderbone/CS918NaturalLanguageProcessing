...
if __name__ == '__main__':
    ...
    pp_back_afterlemma1 = perplex_back1(data_3000, data_16000)
    pp_back_afterlemma2 = perplex_back2(data_3000, data_16000)
    pp_back_afterlemma3 = perplex_back3(data_3000, data_16000)
    pp_back_afterlemma = perplex_back(data_3000, data_16000)
    # pp_back_afterlemma = perplex_back1(data_3000, data_16000)
    ...
    print('perplexity_back_afterlemma of remaining rows is ' + str(pp_back_afterlemma))
    print('perplexity_back_afterlemma1 of remaining rows is ' + str(pp_back_afterlemma1))
    print('perplexity_back_afterlemma2 of remaining rows is ' + str(pp_back_afterlemma2))
    print('perplexity_back_afterlemma3 of remaining rows is ' + str(pp_back_afterlemma3))
