...
def get_vect():
    if os.path.isfile('X.pkl') and os.path.isfile('vector.pickel'):
        return
    else:
        vect = CountVectorizer(stop_words='english',ngram_range=(1,2), max_features=10000, lowercase=True)
...
def word_embedding2(split_corpus):
    ...
    for i in split_corpus:
        # print(i)
        model = word2vec.Word2Vec([i], size=300)
...
#         # print(i)
#         # print(len(i))
#         model = word2vec.Word2Vec([i], min_count=1, size=400)
#         # print(model.vocabulary)
...
def word_embedding3(split_corpus):
    ...
    #     # print(i)
    #     # print(len(i))
    # if os.path.isfile('train_word_embed.pkl'):
    #     return
    # else:
    mymodel = word2vec.Word2Vec(split_corpus, min_count=1, size=400)
    pickle.dump(mymodel, open('train_word_embed.pkl', 'wb'))
    word_embedding4(split_corpus, model = mymodel)

def word_embedding3_test(split_corpus):
    mymodel = pickle.load(open('train_word_embed.pkl', 'rb'))
    word_embedding4(split_corpus, model=mymodel, size=400)
...
#     for i in split_corpus:
#         # print(i)
#         model = word2vecReader.Word2Vec([i])
#         # print(model.vocabulary)
#         # print(model.wv.vocab)
#         # s = model.wv.syn0
#         s = model.wv.vectors
...
# print(F3)
F8 = word_embedding3(split_corpus)
# print(F4)
...
for classifier in ['Logistic Regression','Random Forest', 'Naive Bayes', 'Decision Tree',  'KNN']:
...
# for classifier in ['Naive Bayes', 'Decision Tree', 'Logistic Regression', 'Random Forest', 'KNN']:
    ...
    for testset in testsets.testsets:
        ...
        tF8 = word_embedding3_test(ts_corpus)
