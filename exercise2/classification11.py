...
# def get_train_senti_score(split_corpus):
#     if os.path.isfile('F8.pkl'):
#         return pickle.load('F8.pkl', 'rb')
#     else:
...
for classifier in ['Logistic Regression','SVM','SGD','Naive Bayes','Random Forest','KNN']:
...
# for classifier in ['Naive Bayes', 'Decision Tree', 'Logistic Regression', 'Random Forest', 'KNN']:
    ...
    for testset in testsets.testsets:
        ...
        # Xt = tF1
        # Xt = tF3
        # ans_num0 = model.predict_proba(Xt)
        # print(ans_num0)


        ans_num = model.predict(Xt)
        # ans_num = model.predict(ans_num0)
        # print(ans_num)
